...
function ds_unterschreiben_formular_parts(){
    ...
    $HTML .= " <input type='checkbox' name='ds' value='ds_checked'><label for='ds'>Ich stimme den Nutzungsbedingungen, sowie der Speicherung und Verarbeitung gem&auml;&szlig; der Datenschutzerkl&auml;rung zu.</label>";
