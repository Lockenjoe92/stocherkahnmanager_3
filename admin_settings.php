...
$SettingTableItems .= table_form_range_item('Fr&uuml;hester Verleihbeginn', 'earliest_begin', 5, 23, intval(lade_db_einstellung('earliest_begin')), false);
$SettingTableItems .= table_form_range_item('Sp&auml;tester Verleihbeginn', 'latest_begin', 5, 23, intval(lade_db_einstellung('latest_begin')), false);
